...
public class CalendarWindow extends JFrame implements ActionListener, MouseListener, FocusListener {
    ...
    JButton saveDailyRecord, deleteDailyRecord, raedDailyRecord;
    File dir;
    ...
    public CalendarWindow() {
        ...
        previousYear = new JButton("last year");
        ...
        saveDailyRecord = new JButton("save data");
        deleteDailyRecord = new JButton("del data");
        raedDailyRecord = new JButton("read data");
        saveDailyRecord.addActionListener(this);
        deleteDailyRecord.addActionListener(this);
        raedDailyRecord.addActionListener(this);
        JPanel pSouth = new JPanel();
        pSouth.add(saveDailyRecord);
        pSouth.add(deleteDailyRecord);
        pSouth.add(raedDailyRecord);
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == nextYear) {
            ...
            doMark();
        } else if (e.getSource() == raedDailyRecord) {
